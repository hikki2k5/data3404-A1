...
demo.py
  ↓
execution/query_engine.py
  ├────→ parser/query.py
  ├────→ join/* algorithms
  ├────→ projection/projection.py
  └────→ global_module/database_manager.py
         │   ├────→ global_module/catalog.py
